...
This problem is very similar to $k$-way partitioning \ref{optDutchFlag}, \ref{mcIlroy93}, which is a generalization of the Dutch Flag problem posed by Djikstra \ref{mcMaster78}.  Our problems differ only because the $k$-way partitioning elements have a definite ordering.

Another closely related problem is found in kidney exchanges and other market clearinghouses.    
